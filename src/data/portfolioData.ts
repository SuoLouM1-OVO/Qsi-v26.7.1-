import { Project, AboutData, FloatingItem } from '../types';
...
export const PROJECTS: Project[] = INITIAL_PROJECTS;
...
export const ABOUT_DATA: AboutData = {
  ...
  "awards": [
    {
      "year": "2025",
      "title": "Tokyo TDC Annual Awards",
      "organization": "Tokyo Type Directors Club",
      "category": "Nominated - Book Design"
    },
    {
      "year": "2024",
      "title": "Hiiibrand Typography Award",
      "organization": "Hiii Typography Competition",
      "category": "Gold Award - Poster"
    },
    {
      "year": "2024",
      "title": "中国最美的书 (Beauty of Books in China)",
      "organization": "Shanghai Press & Publication",
      "category": "Selected Award - 《虎瓷》"
    },
    {
      "year": "2023",
      "title": "GDC Award (Graphic Design in China)",
      "organization": "SGDA",
      "category": "Merit Award - Brand Identity"
    }
  ]
};

export const FLOATING_ITEMS: FloatingItem[] = undefined;
